...
-(void)setImageDisabled:(UIImage *)imageDisabled{
    for (UIView *v in self.subviews) {
        if ([v isKindOfClass:[MACalendarDay class]]) {
            MACalendarDay *d = (MACalendarDay *)v;
            d.imageDisabled = imageDisabled;
        }
    }
...
-(void)setImageHighlighted:(UIImage *)imageHighlighted{
    for (UIView *v in self.subviews) {
        if ([v isKindOfClass:[MACalendarDay class]]) {
            MACalendarDay *d = (MACalendarDay *)v;
            d.imageHighlighted = imageHighlighted;
        }
    }
...
-(void)setAnimationOption:(MACalendarDayAnimationOption)animationOption{
    for (UIView *v in self.subviews) {
        if ([v isKindOfClass:[MACalendarDay class]]) {
            MACalendarDay *d = (MACalendarDay *)v;
            d.animationOption = animationOption;
        }
    }
